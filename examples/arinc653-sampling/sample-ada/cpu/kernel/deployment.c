...
uint8_t pok_global_ports_to_local_ports[POK_CONFIG_NB_GLOBAL_PORTS] = {
    pr2_pdatain, pr1_pdataout};
pok_bus_identifier_t pok_global_ports_to_bus[POK_CONFIG_NB_GLOBAL_PORTS] = {
...
uint8_t pok_local_ports_to_global_ports[POK_CONFIG_NB_PORTS] = {
    pr2_pdatain_global, pr1_pdataout_global};
...
uint8_t *pok_ports_by_partition[POK_CONFIG_NB_PARTITIONS] = {pr2_partport,
                                                             pr1_partport};
...
uint8_t pok_ports_identifiers[POK_CONFIG_NB_PORTS] = {pr2_pdatain,
                                                      pr1_pdataout};
uint8_t pok_ports_nb_destinations[POK_CONFIG_NB_PORTS] = {0, 1};
uint8_t *pok_ports_destinations[POK_CONFIG_NB_PORTS] = {
    NULL, pr1_pdataout_deployment_destinations};
pok_port_kind_t pok_ports_kind[POK_CONFIG_NB_PORTS] = {POK_PORT_KIND_SAMPLING,
