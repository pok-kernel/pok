...
void user_integrated_navigation(types__navsensordata navsensordatafromnsp,
...
void user_guidance_processing(types__navdata navdatafromin,
...
void user_flight_plan_processing(types__guidancedata guidancefromgp,
...
void user_aircraft_performance_calculation(
    types__fpdata fpdatafromfpp, types__navdata navdatafromin,
    types__fuelflowdata fuelflow, types__performancedata *perfdatatofpp) {
...
void user_handle_page_request(types__pagerequestcmd new_page_request_from_pcm,
...
void user_periodic_io(types__fuelflowdata fromoutside_fuelflow,
                      types__navsignaldata fromoutside_navsignal,
                      types__fuelflowdata *fuelflow,
                      types__navsignaldata *navsignal,
                      types__guidancedata guidanceout, types__fpdata fpdataout,
