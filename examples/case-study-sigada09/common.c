...
void user_print_infos() { printf("Informations from the infos thread\n"); }

/*
void user_decrement_shaded_and_black (sigada09__shaded_i* shaded_data,
sigada09__black_i* black_data)
{
