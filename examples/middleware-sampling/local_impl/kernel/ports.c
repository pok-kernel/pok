...
uint8_t *pok_ports_by_partition[POK_CONFIG_NB_PARTITIONS] = {pok_pr1_ports,
                                                             pok_pr2_ports};
...
uint8_t *pok_ports_destinations[POK_CONFIG_NB_PORTS] = {
    pok_ports_dataout_destinations, NULL};

uint8_t pok_ports_kind[POK_CONFIG_NB_PORTS] = {POK_PORT_KIND_SAMPLING,
