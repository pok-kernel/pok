...
pok_ret_t pok_buffer_receive(const pok_buffer_id_t id, const uint64_t timeout,
  ...
  memcpy(data, &pok_buffers_data[pok_buffers[id].index + pok_buffers[id].off_b],
         pok_buffers[id].msgsize);
  pok_buffers[id].off_b =
      (pok_buffers[id].off_b + pok_buffers[id].msgsize) % pok_buffers[id].size;
