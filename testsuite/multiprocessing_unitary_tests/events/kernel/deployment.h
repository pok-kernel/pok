...
#define POK_CONFIG_PARTITIONS_NLOCKOBJECTS {1, 1, 0}
#define POK_CONFIG_PARTITIONS_NTHREADS {4, 3, 1}
#define POK_CONFIG_PARTITIONS_SCHEDULER                                        \
  {POK_SCHED_STATIC, POK_SCHED_STATIC, POK_SCHED_RR}
#define POK_CONFIG_PARTITIONS_SIZE {133120, 133120, 133120}
#define POK_CONFIG_PROCESSOR_AFFINITY {15, 15, 15}
...
#define POK_CONFIG_SCHEDULING_SLOTS {400000000, 200000000, 100000000}
